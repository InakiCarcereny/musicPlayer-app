export function Next () {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-player-track-next-filled" width="32" height="32" viewBox="0 0 24 24" stroke="#9e9e9e" fill="none">
