export function Next () {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-player-track-next-filled text-indigo-500" width="32" height="32" viewBox="0 0 24 24" stroke="currentColor" fill="none">
