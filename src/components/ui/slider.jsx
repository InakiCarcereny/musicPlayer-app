...
const Slider = React.forwardRef(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Track
      className="relative h-2 w-full grow overflow-hidden rounded-full bg-white dark:bg-indigo-500">
      <SliderPrimitive.Range className="absolute h-full bg-indigo-500 dark:bg-slate-50" />
    </SliderPrimitive.Track>
